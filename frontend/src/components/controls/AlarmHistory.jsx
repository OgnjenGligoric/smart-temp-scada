...
const AlarmHistory = ({ alarmHistory }) => {
  return (
    <motion.div
      className="bg-gray-800 bg-opacity-50 backdrop-blur-md shadow-lg rounded-xl p-6 border border-gray-700 mb-6 overflow-hidden"
          ...
          alarmHistory.map(alarm => (
            ...
            >
              <div className="flex items-center mr-4">
                <span className="text-sm text-gray-400">{alarm.timestamp}</span>
              </div>
